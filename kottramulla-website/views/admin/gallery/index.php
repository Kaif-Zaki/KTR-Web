...
<div class="proj-header">
    <div>
        <p class="proj-eyebrow">Visual Assets</p>
...
<?php if (empty($rows)): ?>
    <div class="gal-empty">
        ...
        <p class="gal-empty-text">Your gallery is currently empty.</p>
        <a class="proj-add-btn" href="<?= url('/admin/gallery/create') ?>">Start Uploading</a>
    </div>
<?php else: ?>
    <div class="gal-grid">
            ...
            <div class="gal-card">
                ...
                <div class="gal-info">
                    <p class="gal-caption" title="<?= e((string) ($row['caption'] ?? 'No caption')) ?>">
                        <?= e((string) ($row['caption'] ?? 'No caption')) ?>
                    </p>
