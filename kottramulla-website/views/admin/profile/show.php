<section class="profile-header">
    <span class="kicker">Admin Security</span>
...
<section class="profile-grid">
    <article class="card">
        ...
        <form method="post" action="<?= url('/admin/profile/email') ?>"  class="stack-form">
    ...
    <article class="card">
        ...
        <form method="post" action="<?= url('/admin/profile/password') ?>"  class="stack-form">
            <input type="hidden" name="_csrf" value="<?= e($csrfToken) ?>">
