<section class="auth-shell single">
    <article class="card auth-card">
        ...
        <form method="post" action="/admin/reset-password" class="stack-form">
            <input type="hidden" name="_csrf" value="<?= e($csrfToken) ?>">

            <label>Email</label>
            <input type="email" name="email" value="<?= e($prefillEmail) ?>" autocomplete="email" required>
        ...
        <div class="auth-actions">
            <a href="/admin/forgot-password">Request a new code</a>
